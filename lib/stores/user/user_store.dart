...
abstract class _UserStore with Store {
  ...
  void setLoggedUser(String value) {
    ...
    _repository.setLoggedUser(value).then((_) {

    });
  }

  @action
  void setLoggedTimeStamp(String value) {
    loggedTimeStamp = value;
    _repository.setLoggedTimeStamp(value).then((_) {
