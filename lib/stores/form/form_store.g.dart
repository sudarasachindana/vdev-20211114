...
mixin _$FormStore on _FormStore, Store {
  ...
  final _$loginTimeStampAtom = Atom(name: '_FormStore.loginTimeStamp');

  @override
  DateTime get loginTimeStamp {
    _$loginTimeStampAtom.reportRead();
    return super.loginTimeStamp;
  }

  @override
  set loginTimeStamp(DateTime value) {
    _$loginTimeStampAtom.reportWrite(value, super.loginTimeStamp, () {
      super.loginTimeStamp = value;
    });
  }
  ...
  final _$userMapAtom = Atom(name: '_FormStore.userMap');
  ...
  @override
  set userMap(Map<String, String> value) {
